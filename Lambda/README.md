...
- Serverless is not about eliminating servers altogether. Instead, serverless computing is a cloud computing execution model where a developer do not need to manage servers directly. 
- just write and deploy the code, while the cloud provider takes care of all the underlying infrastructure.

## What is AWS Lambda?

- AWS Lambda is a compute service that lets you run your code in response to events without the need to provision or manage servers. 
